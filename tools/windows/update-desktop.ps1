...
# The repository is public now, so no token is needed. One saved earlier (or given in
# EDUBOARD_GITHUB_TOKEN) is still used, but dropped if GitHub turns it down.
